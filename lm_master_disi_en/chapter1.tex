...
Personal narratives are a compelling form of storytelling, representing the recollections of events or connected sequences of events in which the narrator has played an active or passive role. These narratives, often intimate and reflective, find their expression in various mediums, from handwritten diaries to digital travelogues, encompassing both speech and text. The power of personal narratives lies in their ability to convey individual experiences, emotions, and perspectives, making them a rich source of insight into the human condition \cite{noauthor_undated-sy, doi:10.1080/1361332032000044567, Bailey2002-fw} in particular mental health \cite{}. % CONNECT WITH TEO impictyl SOMEHOW
...
In recent years, large language models have emerged as a transformative force in the realm of artificial intelligence. These models, exemplified by their state-of-the-art language generation capabilities, have achieved remarkable success in a wide range of applications and domains, including natural language understanding and generation \cite{openai2023gpt4, touvron2023llama, touvron2023llama2, brown2020language}. Their capacity to comprehend and generate human-like text \cite{schramowski2022large} has us posit the question of whether large language models can be used to elicit personal narratives effectively.

This thesis investigates the application of employing large language models in the elicitation of personal narratives. Our primary objective is to investigate whether these models can be prompted to engage in interactions that lead to the correct elicitation of personal narratives. 
% interview process
These narratives should be elicited through the interview technique, which means that each narrative is recounted by the narrator and the model is given the role of interviewer. We would like to expect the elicitations to be short and focused on an event or topic presented in the narrative, conveying empathy and most importantly, conveying the feeling that the model is actively listening to the narrative, because this is a key requirement in an effective narrative elicitation \cite{Kim2015-es}.

To achieve this objective, we introduce the novel task of personal narrative elicitation, which is paired with a new curated dataset tailored to this purpose. 

This dataset was derived from the mental health dataset presented in \cite{coadapt}. The original data was not in a narrative format, and it was therefore manually reviewed in order to obtain cohesive narratives. As reference points, human crowdsourced elicitations for the narratives presented in this dataset were also collected through Prolific \cite{prolific}. Notably, like the original data, this dataset is in Italian.

After this dataset preparation, an initial test on the LLMs abilities to understand the Italian language was conducted, in order to quickly assess if a model is able to understand Italian prompts. This revealed that many open-source LLMs do not have a correct understanding of the Italian language, due to the significant bias in the English language \cite{}. The few models that were able to answer in Italian, were subjected to the \emph{story cloze test} \cite{mostafazadeh2016corpus}, because this task requires a correct understanding of commonsense knowledge to correctly predict the story closure. This ability of commonsense is an important proxy for listening, in eliciting personal narratives. 

Finally, we proceeded with the task of personal narrative elicitation, analysing the effect of different prompts. In assessing their performances, we draw comparisons with the human crowdsourced elicitation targeting the same narratives. This evaluation involves the use of automatic metrics as well as human evaluation. By utilizing both quantitative and qualitative measures, we aim to gain a comprehensive understanding of the large language models' capabilities in the domain of personal narrative elicitation. The results of our evaluation suggest that with some prompts, certain large language models have the potential to attain performance levels on par with those of human crowdworkers in the task of personal narrative elicitation. 
