...
%of \emph{Automatic Narrative Elicitation}. In this we employed both automatic and human evaluations using as ground truth the collected questions. 
Although the results of automatic evaluation are inconclusive, the results of human evaluation suggest that with some prompts, specific LLMs have the potential to attain performance levels on par with those of crowdworkers in the ANE task. % of \emph{Automatic Narrative Elicitation}. 
