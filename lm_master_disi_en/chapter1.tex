...
Although the results of automatic evaluation are inconclusive, the results of human evaluation suggest that with some prompts, specific LLMs have the potential to attain performance levels on par with those of human crowdworkers in the task of \emph{Automatic Narrative Elicitation}. 
...
\begin{itemize}
    ...
    \item Chapter 3: Methodology. This chapter contains the definition of the task, the description of the presented corpus, the LLMs selection and prompting procedure.
