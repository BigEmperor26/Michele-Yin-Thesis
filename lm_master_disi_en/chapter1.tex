...
\end{itemize}
% [GOALS]
Our main goal is to prompt Large Language Models to elicit Personal Narratives and evaluate their performances compared to human crowd workers. This evaluation is done through both automatic metrics, such as BLEU, METEOR and other relevant statistics, and human evaluation according to Mahed et al \cite{}. 
