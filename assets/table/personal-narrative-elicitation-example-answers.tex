\begin{table}[ht]
\centering
\caption{Two examples of narratives and model outputs for different experimental settings. In order to evaluate the models, their outputs are processed by removing special invalid characters and only the first sentence, marked by the dot (\emph{?}), is considered. }
