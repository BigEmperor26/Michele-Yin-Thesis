...
\label{tab:personal-narrative-elicitation-example-answers}
    ...
    % \begin{tabular}{p{1.5cm}|p{3cm}|p{5cm}|p{2.5cm}|p{2cm}}
        \toprule
        \multicolumn{6}{c}{\thead{Examples of model outputs for the ANE task on different experimental settings}} \\
        \midrule
