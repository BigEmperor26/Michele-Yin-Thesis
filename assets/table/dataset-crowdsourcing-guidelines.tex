\begin{table}[!htbp]
\centering
\caption{Eexample that was provided to the users of the crowdsourcing data collection. It contains one example of narrative with one example respectively of correct and incorrect eliciting question, paired with their respective motivation.}
