\begin{table}[!htbp]
\centering
\caption{Table reporting an example that was provided to the users of the crowdsourcing data collection with one example of narrative with one example respectively of correct and incorrect eliciting question with their respective motivation. The users were shown the same narrative, but with more examples of incorrect eliciting questions with their respective motivations in order to train them against easy pitfalls in the eliciting question.}
