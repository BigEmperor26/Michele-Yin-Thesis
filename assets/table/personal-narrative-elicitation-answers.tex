...
\multicolumn{2}{l}{\thead{Human elicitation}} & \multicolumn{3}{l}{Mi fa piacere sentirlo, come avete celebrato?}
\midrule
 \thead{Colour}& \thead{Guidelines} & \thead{Shot} & \thead{Model name} & \thead{Model elicitation} \\
\midrule
...
\cline{3-5}
 ...
 &  &  & Gpt 3 & Che cosa hai fatto nel tuo compleanno con la tua famiglia riunita? \\
 &  &  & Gpt 4 & Sembra che tu abbia avuto un bel compleanno. Cera qualche evento speciale o tradizione che hai condiviso con la tua famiglia durante la celebrazione? \\
